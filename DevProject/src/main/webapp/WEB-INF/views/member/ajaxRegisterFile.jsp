...
<body>
	...
	<p>Ajax 방식으로 전달할 파일 요소값을 스프링 MVC 지원하는 MultipartFile 매개변수로 처리한다.</p>
	<div>
...
function isImageFile(file) {
	...
	// 확장자 중 이미지에 해당하는 확장자가 아닌 경우 포함되어 있는 문자가 없으니깐 -1(false)가 리턴
