...
public class UploadFileUtils {
	...
	public static String uploadFile(String uploadPath, String originalName, byte[] fileData) throws IOException {
		...
		// 2023/06/07 폴더 경로를 만들고, /2023/03/07 폴더 경로를 리턴받는다.
	...
	private static void makeThumbnail(String uploadPath, String path, String fileName) throws IOException {
		...
		// Method.AUTOMATIC : 취소 시간 내에 가장 잘 보이는 이미지를 얻기 위한 사용 방식
		// Model.Fit_TI_HEIGHT : 이미지 방향과 상관없이 주어진 높이 내에서 가장 잘 맞는 이미지로 계산 (높이 위주)
	...
	private static String calcPath(String uploadPath) {
		...
		// DecimalFormat("00") :: 두자리에서 빈자리를 0으로 채움 ex) 1월 2월 3월 등등..
