...
public class JSPHomeController {
	 ...
	 * - 현재는 스크립틀릿을 사용하기 보다는 JSTL과 같은 커스텀 태그라이브러리와 EL을 조합해서 JSP을 구현하는 방법을 많이 사용한다.
	 * 
	 * 3. 커스텀 태그 라이브러리
	...
	public String home0104(Model model) {
		...
		memberMap.put("password", "54321");
		memberMap.put("email", "kd123@gmail.com");
		memberMap.put("userName", "홍길순");
		
		// memberMap이라는 키를 정확하게 명시했기 때문에, jsp 페이지에서 명시된 키로 데이터를 출력할 수 있다.
