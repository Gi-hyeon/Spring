	...
	public String getPagingHTML() {
		...
		if (startPage > 1) {
			html.append("<li class='page-item'><a href='' class='page-link' data-page='"
					+(startPage - blockSize)+"'><span class='material-icons'>keyboard_arrow_left</span></a><span class='sr-only'>Previous</span></li>");
		} 
		...
		if (endPage < totalPage) {
			html.append("<li class='page-item'><a href='' class='page-link' data-page='"
					+ (endPage + 1) + "'><span class='material-icons'>keyboard_arrow_right</span></a><span class='sr-only'>Next</span></a></li>");
		}
		html.append("</ul>");
